...
l.inputs_icer <- list(
  ...
  c.mci_hc = 6042*1.12 +  460*12, 
  c.mil_hc = 6042*1.56 +  965*12 + 0.21*365*0.333, # patient medical + informal carer medical + ChEI
  c.mod_hc = 6042*1.93 + 1544*12 + 0.66*365*0.333, 
  c.sev_hc = 6042*1.93 + 1930*12, 
  c.mci_hc_i = 6042*1.12 +  460*12, 
  c.mil_hc_i = 6042*1.56 +  965*12 + 0.21*365*0.333, 
  c.mod_hc_i = 6042*1.93 + 1544*12 + 0.66*365*0.333, 
  c.sev_hc_i = 6042*1.93 + 1930*12, 
  c.mci_sc = 0, 
  c.mil_sc = 0, 
  c.mod_sc = 0, 
  c.sev_sc = 0, 
